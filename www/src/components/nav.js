...
const Nav = () => (
  <NavTemplate className="col-2">
    <div className="nav">
      <Link exact to="/" className="nav-link" activeClassName="is-active">Getting Started</Link>
      <SubNav>
      ...
      <Link exact to="/styles/colors" className="nav-link" activeClassName="is-active">Styles</Link>
      <SubNav>
